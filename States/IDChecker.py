        ...
        while True:
            ...
            while retries < self._max_retries:
                try:
                    ...
                    session.get(
                        url="https://www.accessidaho.org/itd/driver/plates/plate/85",
                        timeout=10
                    )
                    ...
                    # Timeout of 10 seconds incase of a stuck request.
                    session.post(
                        url="https://www.accessidaho.org/itd/driver/plates/check",
                        data=data,
                        headers=headers,
                        timeout=10
                    )
                    ...
                    # Make the request for process page 3, completing combination check.
                    # Timeout of 10 seconds incase of a stuck request.
                    response = session.post(
                        url="https://www.accessidaho.org/itd/driver/plates/checkAvailability",
                        data=data,
                        headers=headers,
                        timeout=10
                    )
