            ...
            while retries < self._max_retries:
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        # "This plate number is currently available." not being in the request's response means it is taken.
                        ...
                        # "This plate number is currently available." being in the request's response means it is available.
