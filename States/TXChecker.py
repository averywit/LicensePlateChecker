        ...
        while True:
            ...
            try:
                ...
                headers = {
                    ...
                    "referer": f"https://www.myplates.com/design/personalized/passenger/lone-star-black/{url[69:len(url)-4]}",
                ...
                if '{"status":"available"' not in str(response.text):
                    print(colored("PLATE UNAVAILABLE:  " + url[69:len(url)-4], 'red'))
                else:
                    print(colored("PLATE AVAILABLE:  " + url[69:len(url)-4], 'green'))
                    f = open("outputresults.txt", "a")
                    f.write(url[69:len(url)-4] + "\n")
                    f.close()

            except:
                self._job_queue.put(url)
...
if __name__ == '__main__':
    ...
    index = 0
    stupidparse = ""
    urlfront = "https://www.myplates.com/api/licenseplates/passenger/lone-star-black/"
    urlback = "?_=1"
