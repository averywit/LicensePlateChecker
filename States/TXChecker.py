            ...
            while retries < self._max_retries:
                try:
                    ...
                    headers = {
                        ...
                        "referer": f"https://www.myplates.com/design/personalized/passenger/lone-star-black/{word}",
                    ...
                    response = session.get(
                        url=f"https://www.myplates.com/api/licenseplates/passenger/lone-star-black/{word}?_=1",
                        headers=headers,
                        timeout=10
                    )
                    ...
                    if response.status_code == 200:
                        ...
                        # "xed;f" being in the request's response means it is available.
                        # Record an available license plate combination
                        if "xed;f" in str(response.content):
                            print(colored("PLATE UNAVAILABLE:  " + word, 'red'))
                        
                        # "xed;f" not being in the request's response means it is taken.
