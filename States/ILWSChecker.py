    ...
    def run(self):
        while True:
            ...
            try:
                ...
                req.get(url="https://apps.ilsos.gov/pickaplate/", headers=header1, proxies=proxies)
                ...
                chewy5 = str(response.text)
                chewy6 = chewy5[15643:15655]
                chewy7 = chewy6.replace('"', '')
                chewy8 = chewy7.replace('>', '')
                chewy9 = chewy8.replace('=', '')
                chewy10 = chewy9.strip()
                ...
                response = req.post(url="https://apps.ilsos.gov/pickaplate/pickaplate", data=data3, headers=header4,
                                    proxies=proxies)
