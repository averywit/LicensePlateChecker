        ...
        while True:
            ...
            while retries < self._max_retries:
                try:
                    ...
                    # Header to complete the combination check.
                    header = {
                        ...
                        "Content-Length": str(524 + len(word)),
                    ...
                    response = session.post(
                        url="https://apps.sd.gov/RV66Renewals/checkplates/checkplates.aspx",
                        data=data,
                        headers=header,
                        timeout=10
                    )
                    ...
                    if response.status_code == 200:
                        ...
                        # "not in use" being in the request's response means it is available.
                        ...
                        # "not in use" not being in the request's response means it is taken.
