    ...
    def run(self):
        while True:
            ...
            headers = {
                ...
                "origin": "https://www.myplates.com.au",
                "referer": "https://www.myplates.com.au/",
            ...
            if '"available":true' not in str(response.text):
                print(colored("PLATE UNAVAILABLE:  " + url[33:len(url)-26], 'red'))
            else:
                print(colored("PLATE AVAILABLE:  " + url[33:len(url)-26], 'green'))
                f = open("outputresults.txt", "a")
                f.write(url[33:len(url)-26] + "\n")
                f.close()
...
if __name__ == '__main__':
    ...
    index = 0
    stupidparse = ""
    urlfront = "https://myrta.com/plateapi/plate/"
    urlback = "?vehicleType=LIGHT_VEHICLE"
